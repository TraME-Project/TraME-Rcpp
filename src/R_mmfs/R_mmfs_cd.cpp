...
RCPP_MODULE(mmfs_cd_module)
{
    ...
    void (mmfs_cd_R::*build_1)(arma::mat, arma::mat) = &mmfs_cd_R::build_R ;
    void (mmfs_cd_R::*build_2)(arma::mat, arma::mat, bool) = &mmfs_cd_R::build_R ;

    SEXP (mmfs_cd_R::*M_1)(arma::mat, arma::mat) = &mmfs_cd_R::M_R ;
    SEXP (mmfs_cd_R::*M_2)(arma::mat, arma::mat, Rcpp::IntegerVector, Rcpp::IntegerVector) = &mmfs_cd_R::M_R ;

    // now we can declare the class
    class_<trame::mmfs::cd>( "mmfs_cd" )
        .default_constructor()
    ...
    class_<mmfs_cd_R>( "mmfs_cd_R" )
        .derives<trame::mmfs::cd>( "mmfs_cd" )
        .default_constructor()
...
void mmfs_cd_R::build_R(arma::mat lambda_inp, arma::mat phi_inp)
{
    try {
...
void mmfs_cd_R::build_R(arma::mat lambda_inp, arma::mat phi_inp, bool need_norm_inp)
{
    try {
...
SEXP mmfs_cd_R::M_R(arma::mat a_xs, arma::mat b_ys)
{
    try {
...
SEXP mmfs_cd_R::M_R(arma::mat a_xs, arma::mat b_ys, Rcpp::IntegerVector x_ind, Rcpp::IntegerVector y_ind)
{
    try {
