 ...
 */
 ...
 RCPP_MODULE(dse_rsc_module)
 {
     ...
     // ETU
     void (dse_rsc_etu_R::*build_ETU_1)(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp, bool need_norm_inp) = &dse_rsc_etu_R::build_ETU_R ;
     void (dse_rsc_etu_R::*build_ETU_2)(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp) = &dse_rsc_etu_R::build_ETU_R ;
     SEXP (dse_rsc_etu_R::*solve_ETU_2)(Rcpp::CharacterVector solver_inp) = &dse_rsc_etu_R::solve_R ;
 
     // LTU
     void (dse_rsc_ltu_R::*build_LTU_1)(arma::vec n_inp, arma::vec m_inp, arma::mat lambda_inp, arma::mat phi_inp, bool need_norm_inp) = &dse_rsc_ltu_R::build_LTU_R ;
     void (dse_rsc_ltu_R::*build_LTU_2)(arma::vec n_inp, arma::vec m_inp, arma::mat lambda_inp, arma::mat phi_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp) = &dse_rsc_ltu_R::build_LTU_R ;
     SEXP (dse_rsc_ltu_R::*solve_LTU_2)(Rcpp::CharacterVector solver_inp) = &dse_rsc_ltu_R::solve_R ;
     
     // NTU
     void (dse_rsc_ntu_R::*build_NTU_1)(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, bool need_norm_inp) = &dse_rsc_ntu_R::build_NTU_R ;
     void (dse_rsc_ntu_R::*build_NTU_2)(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp) = &dse_rsc_ntu_R::build_NTU_R ;
     SEXP (dse_rsc_ntu_R::*solve_NTU_2)(Rcpp::CharacterVector solver_inp) = &dse_rsc_ntu_R::solve_R ;
 
     // TU
     void (dse_rsc_tu_R::*build_TU_1)(arma::vec n_inp, arma::vec m_inp, arma::mat phi_inp, bool need_norm_inp) = &dse_rsc_tu_R::build_TU_R ;
     void (dse_rsc_tu_R::*build_TU_2)(arma::vec n_inp, arma::vec m_inp, arma::mat phi_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp) = &dse_rsc_tu_R::build_TU_R ;
 ...
 void dse_rsc_etu_R::build_ETU_R(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp, bool need_norm_inp)
 {
     try {
 ...
 void dse_rsc_etu_R::build_ETU_R(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp)
 {
     try {
 ...
 void dse_rsc_ltu_R::build_LTU_R(arma::vec n_inp, arma::vec m_inp, arma::mat lambda_inp, arma::mat phi_inp, bool need_norm_inp)
 {
     try {
         int nbX = n_inp.n_elem;
         int nbY = m_inp.n_elem;
 ...
 void dse_rsc_ltu_R::build_LTU_R(arma::vec n_inp, arma::vec m_inp, arma::mat lambda_inp, arma::mat phi_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp)
 {
     try {
         trame::arums::rsc rsc_1 = static_cast<trame::arums::rsc&>(arums_G_inp);
         trame::arums::rsc rsc_2 = static_cast<trame::arums::rsc&>(arums_H_inp);
 ...
 void dse_rsc_ntu_R::build_NTU_R(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, bool need_norm_inp)
 {
     try {
         int nbX = n_inp.n_elem;
         int nbY = m_inp.n_elem;
 ...
 void dse_rsc_ntu_R::build_NTU_R(arma::vec n_inp, arma::vec m_inp, arma::mat alpha_inp, arma::mat gamma_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp)
 {
     try {
         trame::arums::rsc rsc_1 = static_cast<trame::arums::rsc&>(arums_G_inp);
         trame::arums::rsc rsc_2 = static_cast<trame::arums::rsc&>(arums_H_inp);
 ...
 void dse_rsc_tu_R::build_TU_R(arma::vec n_inp, arma::vec m_inp, arma::mat phi_inp, bool need_norm_inp)
 {
     try {
         int nbX = n_inp.n_elem;
         int nbY = m_inp.n_elem;
 ...
 void dse_rsc_tu_R::build_TU_R(arma::vec n_inp, arma::vec m_inp, arma::mat phi_inp, rsc_R arums_G_inp, rsc_R arums_H_inp, bool need_norm_inp)
 {
     try {
         trame::arums::rsc rsc_1 = static_cast<trame::arums::rsc&>(arums_G_inp);
         trame::arums::rsc rsc_2 = static_cast<trame::arums::rsc&>(arums_H_inp);
