...
RCPP_MODULE(dse_logit_module)
{
    ...
    class_<trame::dse_base>( "dse_base" )
        ...
        // basic objects
        .field( "ETU", &trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::etu>::ETU )
        .field( "LTU", &trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::etu>::LTU )
        .field( "NTU", &trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::etu>::NTU )
    ...
    class_<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::etu>>( "dse_logit_etu_cpp" )
        .derives<trame::dse_base>( "dse_base" )
        .default_constructor()
    ;

    class_<dse_logit_etu_R>( "dse_logit_etu" )
        // .derives<trame::dse_base>( "dse_base" )
        .derives<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::etu>>( "dse_logit_etu_cpp" )
        .default_constructor()
        ...
        .method( "get_arums_G", &dse_logit_etu_R::get_arums_G )
        .method( "set_arums_G", &dse_logit_etu_R::set_arums_G )
        .method( "get_arums_H", &dse_logit_etu_R::get_arums_H )
        .method( "set_arums_H", &dse_logit_etu_R::set_arums_H )
        .method( "set_arums", &dse_logit_etu_R::set_arums )

        .method( "get_transfers", &dse_logit_etu_R::get_transfers_R )
        .method( "set_transfers", &dse_logit_etu_R::set_transfers_R )
    ;

    class_<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::ltu>>( "dse_logit_ltu_cpp" )
        .derives<trame::dse_base>( "dse_base" )
        .default_constructor()
    ;

    class_<dse_logit_ltu_R>( "dse_logit_ltu" )
        // .derives<trame::dse_base>( "dse_base" )
        .derives<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::ltu>>( "dse_logit_ltu_cpp" )
        .default_constructor()
        ...
        .method( "get_arums_G", &dse_logit_ltu_R::get_arums_G )
        .method( "set_arums_G", &dse_logit_ltu_R::set_arums_G )
        .method( "get_arums_H", &dse_logit_ltu_R::get_arums_H )
        .method( "set_arums_H", &dse_logit_ltu_R::set_arums_H )
        .method( "set_arums", &dse_logit_ltu_R::set_arums )

        .method( "get_transfers", &dse_logit_ltu_R::get_transfers_R )
        .method( "set_transfers", &dse_logit_ltu_R::set_transfers_R )
    ;

    class_<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::ntu>>( "dse_logit_ntu_cpp" )
        .derives<trame::dse_base>( "dse_base" )
        .default_constructor()
    ;

    class_<dse_logit_ntu_R>( "dse_logit_ntu" )
        // .derives<trame::dse_base>( "dse_base" )
        .derives<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::ntu>>( "dse_logit_ntu_cpp" )
        .default_constructor()
        ...
        .method( "get_arums_G", &dse_logit_ntu_R::get_arums_G )
        .method( "set_arums_G", &dse_logit_ntu_R::set_arums_G )
        .method( "get_arums_H", &dse_logit_ntu_R::get_arums_H )
        .method( "set_arums_H", &dse_logit_ntu_R::set_arums_H )
        .method( "set_arums", &dse_logit_ntu_R::set_arums )

        .method( "get_transfers", &dse_logit_ntu_R::get_transfers_R )
        .method( "set_transfers", &dse_logit_ntu_R::set_transfers_R )
    ;

    class_<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::tu>>( "dse_logit_tu_cpp" )
        .derives<trame::dse_base>( "dse_base" )
        .default_constructor()
    ;

    class_<dse_logit_tu_R>( "dse_logit_tu" )
        // .derives<trame::dse_base>( "dse_base" )
        .derives<trame::dse<trame::arums::logit,trame::arums::logit,trame::transfers::tu>>( "dse_logit_tu_cpp" )
        .default_constructor()
        ...
        .method( "get_arums_G", &dse_logit_tu_R::get_arums_G )
        .method( "set_arums_G", &dse_logit_tu_R::set_arums_G )
        .method( "get_arums_H", &dse_logit_tu_R::get_arums_H )
        .method( "set_arums_H", &dse_logit_tu_R::set_arums_H )
        .method( "set_arums", &dse_logit_tu_R::set_arums )

        .method( "get_transfers", &dse_logit_tu_R::get_transfers_R )
        .method( "set_transfers", &dse_logit_tu_R::set_transfers_R )
    ;
}
...
void dse_logit_etu_R::build_ETU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, bool need_norm_inp)
{
    try {
        ...
        this->build(n_inp,m_inp,alpha_inp,gamma_inp,tau_inp,logit_1,logit_2,need_norm_inp);
...
void dse_logit_etu_R::build_ETU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, logit_R arums_G_inp, logit_R arums_H_inp, bool need_norm_inp)
{
    try {
        ...
        trame::arums::logit logit_2 = static_cast<trame::arums::logit&>(arums_H_inp);
...
SEXP dse_logit_etu_R::solve_R(Rcpp::CharacterVector solver_inp)
{
    try {
        arma::mat mu_sol;
...
logit_R dse_logit_etu_R::get_arums_G()
{
...
void dse_logit_etu_R::set_arums_G(logit_R arums_G_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
    } catch( std::exception &ex ) {
        forward_exception_to_r( ex );
    } catch(...) {
        ::Rf_error( "trame: C++ exception (unknown reason)" );
...
logit_R dse_logit_etu_R::get_arums_H()
{
...
void dse_logit_etu_R::set_arums_H(logit_R arums_H_inp)
{
    try {
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
    } catch( std::exception &ex ) {
        forward_exception_to_r( ex );
    } catch(...) {
        ::Rf_error( "trame: C++ exception (unknown reason)" );
...
void dse_logit_etu_R::set_arums(logit_R arums_G_inp, logit_R arums_H_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
...
transfers_etu_R dse_logit_etu_R::get_transfers_R()
{
...
void dse_logit_etu_R::set_transfers_R(transfers_etu_R trans_obj_inp)
{
    try {
...
void dse_logit_ltu_R::build_LTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& lambda_inp, const arma::mat& phi_inp, bool need_norm_inp)
{
    try {
        ...
        trame::arums::logit logit_1(nbX,nbY), logit_2(nbY,nbX);
        this->build(n_inp,m_inp,lambda_inp,phi_inp,logit_1,logit_2,need_norm_inp);
    } catch( std::exception &ex ) {
        forward_exception_to_r( ex );
    } catch(...) {
        ::Rf_error( "trame: C++ exception (unknown reason)" );
...
SEXP dse_logit_ltu_R::solve_R(Rcpp::CharacterVector solver_inp)
{
    try {
        arma::mat mu_sol;
        // char* solver = solver_inp[0];
...
logit_R dse_logit_ltu_R::get_arums_G()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_G);
...
void dse_logit_ltu_R::set_arums_G(logit_R arums_G_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
    } catch( std::exception &ex ) {
...
logit_R dse_logit_ltu_R::get_arums_H()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_H);
...
void dse_logit_ltu_R::set_arums_H(logit_R arums_H_inp)
{
    try {
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
    } catch( std::exception &ex ) {
...
void dse_logit_ltu_R::set_arums(logit_R arums_G_inp, logit_R arums_H_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
...
transfers_ltu_R dse_logit_ltu_R::get_transfers_R()
{
...
void dse_logit_ltu_R::set_transfers_R(transfers_ltu_R trans_obj_inp)
{
    try {
...
void dse_logit_ntu_R::build_NTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, bool need_norm_inp)
{
    try {
        ...
        trame::arums::logit logit_1(nbX,nbY), logit_2(nbY,nbX);
        this->build(n_inp,m_inp,alpha_inp,gamma_inp,logit_1,logit_2,need_norm_inp);
    } catch( std::exception &ex ) {
        forward_exception_to_r( ex );
    } catch(...) {
        ::Rf_error( "trame: C++ exception (unknown reason)" );
...
SEXP dse_logit_ntu_R::solve_R(Rcpp::CharacterVector solver_inp)
{
    try {
        arma::mat mu_sol;
        // char* solver = solver_inp[0];
...
logit_R dse_logit_ntu_R::get_arums_G()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_G);
...
void dse_logit_ntu_R::set_arums_G(logit_R arums_G_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
    } catch( std::exception &ex ) {
...
logit_R dse_logit_ntu_R::get_arums_H()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_H);
...
void dse_logit_ntu_R::set_arums_H(logit_R arums_H_inp)
{
    try {
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
    } catch( std::exception &ex ) {
...
void dse_logit_ntu_R::set_arums(logit_R arums_G_inp, logit_R arums_H_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
...
transfers_ntu_R dse_logit_ntu_R::get_transfers_R()
{
...
void dse_logit_ntu_R::set_transfers_R(transfers_ntu_R trans_obj_inp)
{
    try {
...
void dse_logit_tu_R::build_TU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& phi_inp, bool need_norm_inp)
{
    try {
        ...
        trame::arums::logit logit_1(nbX,nbY), logit_2(nbY,nbX);
        this->build(n_inp,m_inp,phi_inp,logit_1,logit_2,need_norm_inp);
    } catch( std::exception &ex ) {
        forward_exception_to_r( ex );
    } catch(...) {
        ::Rf_error( "trame: C++ exception (unknown reason)" );
...
SEXP dse_logit_tu_R::solve_R(Rcpp::CharacterVector solver_inp)
{
    try {
        arma::mat mu_sol;
        // char* solver = solver_inp[0];
...
logit_R dse_logit_tu_R::get_arums_G()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_G);
...
void dse_logit_tu_R::set_arums_G(logit_R arums_G_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
    } catch( std::exception &ex ) {
...
logit_R dse_logit_tu_R::get_arums_H()
{
    logit_R arums_obj_out = static_cast<logit_R&>(arums_H);
...
void dse_logit_tu_R::set_arums_H(logit_R arums_H_inp)
{
    try {
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
    } catch( std::exception &ex ) {
...
void dse_logit_tu_R::set_arums(logit_R arums_G_inp, logit_R arums_H_inp)
{
    try {
        arums_G = static_cast<trame::arums::logit&>(arums_G_inp);
        arums_H = static_cast<trame::arums::logit&>(arums_H_inp);
...
transfers_tu_R dse_logit_tu_R::get_transfers_R()
{
...
void dse_logit_tu_R::set_transfers_R(transfers_tu_R trans_obj_inp)
{
    try {
