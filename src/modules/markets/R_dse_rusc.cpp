...
RCPP_MODULE(dse_rusc_module)
{
    ...
    // ETU
    void (dse_rusc_etu_R::*build_ETU_1)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, bool need_norm_inp) = &dse_rusc_etu_R::build_ETU_R ;
    void (dse_rusc_etu_R::*build_ETU_2)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp) = &dse_rusc_etu_R::build_ETU_R ;
    SEXP (dse_rusc_etu_R::*solve_ETU_2)(Rcpp::CharacterVector solver_inp) = &dse_rusc_etu_R::solve_R ;
 
    // LTU
    void (dse_rusc_ltu_R::*build_LTU_1)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& lambda_inp, const arma::mat& phi_inp, bool need_norm_inp) = &dse_rusc_ltu_R::build_LTU_R ;
    void (dse_rusc_ltu_R::*build_LTU_2)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& lambda_inp, const arma::mat& phi_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp) = &dse_rusc_ltu_R::build_LTU_R ;
    SEXP (dse_rusc_ltu_R::*solve_LTU_2)(Rcpp::CharacterVector solver_inp) = &dse_rusc_ltu_R::solve_R ;
    
    // NTU
    void (dse_rusc_ntu_R::*build_NTU_1)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, bool need_norm_inp) = &dse_rusc_ntu_R::build_NTU_R ;
    void (dse_rusc_ntu_R::*build_NTU_2)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp) = &dse_rusc_ntu_R::build_NTU_R ;
    SEXP (dse_rusc_ntu_R::*solve_NTU_2)(Rcpp::CharacterVector solver_inp) = &dse_rusc_ntu_R::solve_R ;
 
    // TU
    void (dse_rusc_tu_R::*build_TU_1)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& phi_inp, bool need_norm_inp) = &dse_rusc_tu_R::build_TU_R ;
    void (dse_rusc_tu_R::*build_TU_2)(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& phi_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp) = &dse_rusc_tu_R::build_TU_R ;
...
void dse_rusc_etu_R::build_ETU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, bool need_norm_inp)
{
    try {
...
void dse_rusc_etu_R::build_ETU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, const arma::mat& tau_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp)
{
    try {
...
void dse_rusc_ltu_R::build_LTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& lambda_inp, const arma::mat& phi_inp, bool need_norm_inp)
{
    try {
        int nbX = n_inp.n_elem;
        int nbY = m_inp.n_elem;
...
void dse_rusc_ltu_R::build_LTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& lambda_inp, const arma::mat& phi_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp)
{
    try {
        trame::arums::rusc rusc_1 = static_cast<trame::arums::rusc&>(arums_G_inp);
        trame::arums::rusc rusc_2 = static_cast<trame::arums::rusc&>(arums_H_inp);
...
void dse_rusc_ntu_R::build_NTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, bool need_norm_inp)
{
    try {
        int nbX = n_inp.n_elem;
        int nbY = m_inp.n_elem;
...
void dse_rusc_ntu_R::build_NTU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& alpha_inp, const arma::mat& gamma_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp)
{
    try {
        trame::arums::rusc rusc_1 = static_cast<trame::arums::rusc&>(arums_G_inp);
        trame::arums::rusc rusc_2 = static_cast<trame::arums::rusc&>(arums_H_inp);
...
void dse_rusc_tu_R::build_TU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& phi_inp, bool need_norm_inp)
{
    try {
        int nbX = n_inp.n_elem;
        int nbY = m_inp.n_elem;
...
void dse_rusc_tu_R::build_TU_R(const arma::vec& n_inp, const arma::vec& m_inp, const arma::mat& phi_inp, rusc_R arums_G_inp, rusc_R arums_H_inp, bool need_norm_inp)
{
    try {
        trame::arums::rusc rusc_1 = static_cast<trame::arums::rusc&>(arums_G_inp);
        trame::arums::rusc rusc_2 = static_cast<trame::arums::rusc&>(arums_H_inp);
