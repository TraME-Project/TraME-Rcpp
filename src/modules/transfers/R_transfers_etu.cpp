...
void transfers_etu_R::build_R(arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp)
{
    try {
...
void transfers_etu_R::build_R(arma::mat alpha_inp, arma::mat gamma_inp, arma::mat tau_inp, bool need_norm_inp)
{
    try {
